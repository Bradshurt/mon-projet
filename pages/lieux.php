...
<body>
    ...
    <div class="card-container">
      <div class="card">
        <img src="../assets/img/Griffith Observatory.jpg" alt="Griffith Observatory">
        <div class="card-content">
          <h2>Griffith Observatory</h2>
          <p>Une vue imprenable sur Los Angeles et des expositions fascinantes sur l'astronomie.</p>
        </div>
      </div>
