...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="./assets/css/media/responisve-acceuil.css" />
  ...
  <body>
    ...
    <main class="container">
      ...
      <section class="about-section">
        <h2>À propos de Los Angeles Explorer</h2>
        <p>
          Découvrez les lieux emblématiques, les événements incontournables et les trésors cachés de Los Angeles. Que vous soyez un visiteur ou un habitant, laissez-vous guider à travers cette ville fascinante.
        </p>
      </section>
      ...
      <div class="map-container">
        <h2>Explorez Los Angeles</h2>
        <p>Découvrez les lieux emblématiques de la ville grâce à cette carte interactive.</p>
        <iframe
          class="map-style"
